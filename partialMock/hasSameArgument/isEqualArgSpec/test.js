...
(function() {
	...
	(function() {
		...
		var returned = sut([expectedArg,1,'foo'],[expectedArg,1,'foo']);
	...
	(function() {
		...
		var Foo = function () { this.arg = 'arg';};
		var foo = new Foo();
		var foo2 = new Foo();

		var returned = sut({a : 1,b :[{c : 2},foo]},{a : 1,b :[{c : 2},foo2]});
	...
	(function() {
		...
		var Foo = function (value) {this.arg = value;};
		var foo = new Foo(1);
		var foo2 = new Foo(2);
